...
public class TestObjects {
    ...
    public FilmCreateRequest film = new FilmCreateRequest("name1", "Description1",
            LocalDate.of(2000, 10, 15), Duration.ofMinutes(120), new LinkedHashSet<>(), new RatingDto(2, "PG"));
    public FilmUpdateRequest updatedFilm = new FilmUpdateRequest(1, "updatedName", "UpdatedDescription",
            LocalDate.of(2010, 1, 1), Duration.ofMinutes(180), new LinkedHashSet<>(), new RatingDto(2, "PG"));
